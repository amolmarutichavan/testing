...
import com.app.service.mapper.RoomMapper;
...
class RoomResourceIT {
    ...
    void createRoom() throws Exception {
        ...
        assertThat(testRoom.getPricePerNight()).isEqualByComparingTo(DEFAULT_PRICE_PER_NIGHT);
        assertThat(testRoom.getAvailability()).isEqualTo(DEFAULT_AVAILABILITY);
    }
    ...
    void putExistingRoom() throws Exception {
        ...
        assertThat(testRoom.getPricePerNight()).isEqualByComparingTo(UPDATED_PRICE_PER_NIGHT);
        assertThat(testRoom.getAvailability()).isEqualTo(UPDATED_AVAILABILITY);
    }
    ...
    void partialUpdateRoomWithPatch() throws Exception {
        ...
        partialUpdatedRoom.roomType(UPDATED_ROOM_TYPE).pricePerNight(UPDATED_PRICE_PER_NIGHT).availability(UPDATED_AVAILABILITY);
