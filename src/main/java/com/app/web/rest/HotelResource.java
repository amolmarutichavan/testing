...
/**
 * REST controller for managing {@link com.app.domain.Hotel}.
 */
@RestController
@RequestMapping("/api")
public class HotelResource {
    ...
    public ResponseEntity<HotelDTO> updateHotel(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, hotelDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<HotelDTO> partialUpdateHotel(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, hotelDTO.getId().toString())
        );
    }
